		...
		return (
			<div className={`sliding-panel ${show && 'show'}`}>
				...
				{type === 'signup' ? (
					<>
						<IconButton
							className="sliding-panel-button"
							onClick={() => this.handleClick('/driver-signup')}
						>
							Sign Up to Drive
						</IconButton>
						<IconButton
							className="sliding-panel-button"
							onClick={() => this.handleClick('/rider-signup')}
						>
							Sign Up to Ride
						</IconButton>
					</>
					...
					<>
						<IconButton
							className="sliding-panel-button"
							onClick={() => this.handleClick('/driver-login')}
						>
						...
						<IconButton
							className="sliding-panel-button"
							onClick={() => this.handleClick('/rider-login')}
						>
							<Lock className="sliding-panel-icon" />
							Rider Sign In
						</IconButton>
